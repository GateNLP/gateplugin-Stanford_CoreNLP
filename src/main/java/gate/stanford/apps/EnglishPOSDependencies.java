...
@CreoleResource(name = "English POS Tagger and Dependency Parser", comment = "Ready-made application for Stanford English POS tagger and parser", autoinstances = @AutoInstance)
